...
import { AreaChartStacked } from '../index';

import mockData from './AreaChartStacked.mock';
...
const meta: Meta<typeof AreaChartStacked> = {
  title: 'Data Viz Components/Lines/AreaChartStacked',
