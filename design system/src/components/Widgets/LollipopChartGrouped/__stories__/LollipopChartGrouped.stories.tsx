...
import { LollipopChartGrouped } from '../index';

import mockData from './LollipopChartGrouped.mock';
...
const meta: Meta<typeof LollipopChartGrouped> = {
  title: 'Data Viz Components/Bars/LollipopChartGrouped',
  component: LollipopChartGrouped,
  args: {
    dataKeys: {
      x: 'month',
      y: ['male', 'female'],
