...
import { LollipopChartStacked } from '../index';

import mockData from './LollipopChartStacked.mock';
...
const meta: Meta<typeof LollipopChartStacked> = {
  title: 'Data Viz Components/Bars/LollipopChartStacked',
  component: LollipopChartStacked,
  args: {
    dataKeys: {
      x: 'month',
      y: ['male', 'female'],
