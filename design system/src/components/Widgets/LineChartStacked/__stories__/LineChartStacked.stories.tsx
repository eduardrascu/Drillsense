...
import { LineChartStacked } from '../index';

import mockData from './LineChartStacked.mock';
...
const meta: Meta<typeof LineChartStacked> = {
  title: 'Data Viz Components/Lines/LineChartStacked',
  component: LineChartStacked,
  args: {
    dataKeys: {
      x: 'month',
      y: ['male', 'female'],
